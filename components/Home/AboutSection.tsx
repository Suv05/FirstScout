  ...
  return (
    ...
    >
      <div className="max-w-4xl text-center space-y-8">
        {/* Badge */}
        <div
  className="inline-flex items-center px-2 py-1 rounded-full  border-x border-b-0 bg-[#FAFFCB] text-black/80 text-lg border-[#ec4899] shadow-[0_-4px_6px_-1px_rgba(236,72,153,0.3)]"
>
